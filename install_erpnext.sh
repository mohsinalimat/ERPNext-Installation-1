...
sudo apt-get install python3-dev python3.10-dev python3-setuptools libmysqlclient-dev python3-pip python3-distutils python3.10-venv redis-server xvfb libfontconfig wkhtmltopdf
...
cd ~
bench init --frappe-branch version-14 frappe-framework
